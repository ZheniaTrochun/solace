...
public class OFMessageOld {
     ...
     * @param length
     */
    public OFMessageOld setLength(short length) {
        this.length = length;
        return this;
    }
     ...
     * @param length
     */
    public OFMessageOld setLengthU(int length) {
     ...
     * @param type
     */
    public OFMessageOld setType(OFType type) {
        this.type = type;
        return this;
    }
     ...
     * @param version
     */
    public OFMessageOld setVersion(byte version) {
     ...
     * @param xid
     */
    public OFMessageOld setXid(int xid) {
        this.xid = xid;
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof OFMessageOld)) {
            return false;
        }
        OFMessageOld other = (OFMessageOld) obj;
